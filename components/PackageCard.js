...
export default function PackageCard({ pkg, phone = '917796950505' }) {
  ...
  return (
    ...
    >
        ...
        <div style={{ padding: '18px 20px 20px', flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '5px 10px', background: '#F3EFE1', borderRadius: 999, fontSize: 11, color: '#6b7280', marginBottom: 16, width: 'fit-content' }}>
            <Tag size={10} />
            {pkg.hotels}
          </div>
          ...
          <button style={{ marginTop: 14, width: '100%', padding: '12px 0', borderRadius: 999, fontWeight: 600, fontSize: 14, color: '#fff', background: 'linear-gradient(135deg, #8A6E1C, #8A6E1C)', border: 'none', cursor: 'pointer' }}>
            View Details
          </button>
        </div>
    </div>
